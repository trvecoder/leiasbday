...
const lyricsMap = {
  ...
  [
  { time: 15.10, text: "Gaze into her killing jar, I'd sometimes stare for hours" },
  { time: 20.55, text: "Sometimes stare for hours" },
  { time: 22.49, text: "She even poked the holes so I can breathe" },

  { time: 29.66, text: "She bought the last line, I'm just the worst kind" },
  { time: 33.71, text: "Of guy to argue with what you might find" },
  { time: 37.52, text: "And for the last night I lie, could I lie with you?" },

  { time: 45.09, text: "Alright, give up, get down" },
  { time: 49.23, text: "It's just the hardest part of living" },
  { time: 52.76, text: "Alright, she wants it all" },
  { time: 57.07, text: "To come down this time" },

  { time: 63.29, text: "I'm lost in the prescription, she's got something else in mind" },
  { time: 70.41, text: "Something else in mind" },
  { time: 72.55, text: "Check into the hotel Bella Muerte" },

  { time: 79.72, text: "It gives the weak flight, it gives the blind sight" },
  { time: 83.59, text: "Until the cops come or by the last light" },
  { time: 87.44, text: "And for the last night I lie, could I lie next to you?" },

  { time: 95.06, text: "Alright, give up, get down" },
  { time: 99.00, text: "It's just the hardest part of living" },
  { time: 102.72, text: "Alright, she wants it all" },
  { time: 107.00, text: "To come down this time" },

  { time: 110.45, text: "Alright, give up, get down" },
  { time: 114.32, text: "It's just the hardest part of living" },
  { time: 118.07, text: "Alright, she wants it all" },
  { time: 122.32, text: "To come down this time" },

  { time: 128.39, text: "Pull the plug" },
  { time: 131.55, text: "But I'd like to learn your name" },
  { time: 135.63, text: "When holding on" },
  { time: 139.45, text: "Oh, I hope you do the same, aw, sugar" },
  { time: 143.60, text: "Slip into the tragedy" },
  { time: 150.50, text: "You've spun this chamber dry" },

  { time: 158.38, text: "Alright, give up, get down" },
  { time: 162.27, text: "It's just the hardest part of living" },
  { time: 166.06, text: "Alright, she wants it all" },
  { time: 170.42, text: "To come down this time" },

  { time: 173.81, text: "Alright, give up, get down" },
  { time: 177.67, text: "It's just the hardest part of living" },
  { time: 181.41, text: "Alright, she wants it all" },
  { time: 185.71, text: "To come down this time" },

  { time: 189.86, text: "Pull the plug" },
  { time: 192.98, text: "But I'd like to learn your name" },
  { time: 197.09, text: "And holding on" },
  { time: 200.67, text: "Well, I hope you do the same, aw, sugar" }
],
"Cancer":
[
  { time: 12.64, text: "Turn away" },
  { time: 16.71, text: "If you could get me a drink" },
  { time: 20.34, text: "Of water, 'cause my lips are chapped and faded" },
  { time: 24.53, text: "Call my Aunt Marie" },
  { time: 29.37, text: "Help her gather all my things" },
  { time: 33.12, text: "And bury me in all my favorite colors" },
  { time: 37.94, text: "My sisters and my brothers, still" },
  { time: 42.30, text: "I will not kiss you" },
  { time: 50.30, text: "'Cause the hardest part of this is leaving you" },

  { time: 63.53, text: "Now turn away" },
  { time: 67.92, text: "'Cause I'm awful just to see" },
  { time: 71.52, text: "'Cause all my hair's abandoned all my body" },
  { time: 75.83, text: "Oh, my agony" },
  { time: 80.63, text: "Know that I will never marry" },
  { time: 84.72, text: "Baby, I'm just soggy from the chemo" },
  { time: 89.14, text: "But counting down the days to go" },
  { time: 93.54, text: "It just ain't livin'" },
  { time: 97.12, text: "And I just hope you know" },

  { time: 101.89, text: "That if you say goodbye today" },
  { time: 108.28, text: "I'd ask you to be true" },
  { time: 114.29, text: "'Cause the hardest part of this is leaving you" },
  { time: 127.09, text: "'Cause the hardest part of this is leaving you" }
],
"Dead!":[
  { time: 3.32, text: "Yeah" },

  { time: 14.67, text: "And if your heart stops beating" },
  { time: 17.11, text: "I'll be here wondering" },
  { time: 18.82, text: "Did you get what you deserve?" },
  { time: 22.52, text: "The ending of your life" },

  { time: 24.47, text: "And if you get to Heaven" },
  { time: 26.82, text: "I'll be here waiting, babe" },
  { time: 28.62, text: "Did you get what you deserve?" },
  { time: 32.32, text: "The end, and if your life won't wait" },
  { time: 35.62, text: "Then your heart can't take this" },

  { time: 38.77, text: "Have you heard the news that you're dead?" },
  { time: 43.42, text: "No one ever had much nice to say" },
  { time: 45.60, text: "I think they never liked you anyway" },
  { time: 47.89, text: "Oh, take me from the hospital bed" },
  { time: 53.05, text: "Wouldn't it be grand? It ain't exactly what you planned" },
  { time: 55.32, text: "And wouldn't it be great if we were dead?" },

  { time: 59.71, text: "Oh, dead" },

  { time: 63.06, text: "Tongue-tied and oh, so squeamish" },
  { time: 65.46, text: "You never fell in love" },
  { time: 67.26, text: "Did you get what you deserve?" },
  { time: 70.86, text: "The ending of your life" },

  { time: 72.76, text: "And if you get to Heaven" },
  { time: 75.16, text: "I'll be here waiting, babe" },
  { time: 76.91, text: "Did you get what you deserve?" },
  { time: 80.57, text: "The end, and if your life won't wait" },
  { time: 83.82, text: "Then your heart can't take this" },

  { time: 87.01, text: "Have you heard the news that you're dead?" },
  { time: 91.71, text: "No one ever had much nice to say" },
  { time: 93.76, text: "I think they never liked you anyway" },
  { time: 96.18, text: "Oh, take me from the hospital bed" },
  { time: 101.31, text: "Wouldn't it be grand to take a pistol by the hand?" },
  { time: 103.47, text: "And wouldn't it be great if we were dead?" },

  { time: 106.51, text: "And in my honest observation, during this operation" },
  { time: 111.66, text: "Found a complication in your heart, so long" },
  { time: 116.66, text: "'Cause now you've got (Now you've got)" },
  { time: 120.01, text: "Maybe just two weeks to live" },
  { time: 122.06, text: "Is that the most the both of you can give?" },

  { time: 147.17, text: "One, two, one, two, three, four" },
  { time: 149.71, text: "La-la-la, la, la, la-la, la-la-la, la" },
  { time: 154.46, text: "La-la, la-la-la, la, la, well, come on" },
  { time: 159.58, text: "La-la-la, la, la, la-la, la-la-le, la" },
  { time: 164.39, text: "La-la, la-la-la, la, la, oh, mother****" },

  { time: 169.26, text: "La-la-la, la, la, la-la, la-la-le, la, la-la, la-la-la, la, la" },
  { time: 169.26, text: "(If life ain't just a joke, then why are we laughing?)" },
  { time: 173.78, text: "If life ain't just a joke, then why are we laughing?" },
  { time: 178.86, text: "If life ain't just a joke, then why are we laughing?" },
  { time: 179.42, text: "(La-la-la, la, la, la-la, la-la-le, la, la-la, la-la-la, la, la)" },
  { time: 183.91, text: "If life ain't just a joke, then why am I dead?" },
...
"House Of Wolves":[
  ...
  { time: 24.53, text: "'Cause you haven't got a prayer" },
  { time: 26.63, text: "Well, I said hey, hallelujah" },
  { time: 29.36, text: "I'm gonna, come on, sing the praise" },
  { time: 31.53, text: "And let the spirit come on through you" },
  { time: 33.73, text: "We got innocence for days" },

  { time: 36.63, text: "Well, I think I'm gonna burn in Hell" },
  { time: 39.03, text: "Everybody burn the house right down" },

  { time: 40.82, text: "And say what I wanna say" },
  { time: 44.23, text: "Tell me I'm an angel, take this to my grave" },
  { time: 48.80, text: "Tell me I'm a bad man, kick me like a stray" },
  { time: 53.38, text: "Tell me I'm an angel, take this to my grave, yeah, go" },

  { time: 59.03, text: "(S-I-N, I S-I-N)" },
  { time: 61.38, text: "(S-I-N, I S-I-N)" },
  { time: 63.68, text: "(S-I-N, I S-I-N)" },
  { time: 65.87, text: "(S-I-N, I S-I-N)" },

  { time: 67.98, text: "You played ring around the ambulance" },
  { time: 70.17, text: "Like you never gave a care" },
  { time: 72.28, text: "So get the choir boys around you" },
  { time: 74.43, text: "It's a compliment, I swear" },
  { time: 76.63, text: "And I said ashes to ashes, we all fall down" },
  { time: 79.32, text: "I wanna hear you sing the praise" },
  { time: 81.24, text: "I said ashes to ashes, we all fall down" },
  { time: 83.78, text: "We got innocence for days" },

  { time: 86.63, text: "Well, I think I'm gonna burn in Hell" },
  { time: 88.88, text: "Everybody burn the house right down" },

  { time: 90.71, text: "And say what I wanna say" },
  { time: 94.18, text: "Tell me I'm an angel, take this to my grave" },
  { time: 98.73, text: "Tell me I'm a bad man, kick me like a stray" },
  { time: 103.28, text: "Tell me I'm an angel, take this to my grave, yeah" },

  { time: 113.08, text: "You better run like the devil 'cause they're never gonna leave you alone" },
  { time: 117.69, text: "You better hide up in the alley 'cause they're never gonna find you a home" },
  { time: 122.13, text: "And as the blood runs down the walls (Blood runs down the wall)" },
  { time: 124.38, text: "You see me creeping up these halls (Creeping up these halls)" },
  { time: 126.68, text: "I've been a bad mother****, tell your sister I'm another" },
  { time: 129.18, text: "Go, go, go" },

  { time: 130.86, text: "And I said, say what I wanna say" },
  { time: 134.92, text: "Tell me I'm an angel, take this to my grave" },
  { time: 139.38, text: "And tell me I'm a bad man, kick me like a stray" },
  { time: 144.00, text: "Tell me I'm an angel, take this to my grave" },

  { time: 148.58, text: "Tell me I'm a bad, bad, bad, bad man" },
  { time: 153.08, text: "Tell me I'm a bad, bad, bad, bad man" },
  { time: 157.63, text: "Tell me I'm a bad, bad, bad, bad man" },
  { time: 162.13, text: "Tell me I'm a bad, bad, bad, bad man" },

  { time: 169.58, text: "So get up" },
  { time: 171.88, text: "So get out" },
  { time: 174.63, text: "And S-I-N, I S-I-N" }
]
...
function updatePlayButtonIcon() {
  ...
  if (btn) {
    if (isEnded) {
      btn.src = "assets/replay-1.png.png";
    } else {
